    ...
    <>
      <section className='bg-[#121212]'>
            <div className='flex justify-between px-5'>
                <h1 className='pt-[3rem] font-bold text-[1.5rem] text-white  hover:underline cursor-pointer'>Trending Episodes</h1>
            ...
            <section className='px-2 text-white'>
                <section className='flex gap-1'>
                    <div className='hover:bg-[#1E1E1E] hover:transition-transform ease-out duration-100 mt-1 pb-[2rem] w-[11rem] px-4 rounded-md'>
                        ...
                        <h1 className='font-semibold mb-1 w-[8.7rem]'>Welcome back,RJ Balaji</h1>
