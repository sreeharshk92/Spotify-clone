    ...
    <>
        <section className='bg-[#121212]'>
            <div className='flex justify-between px-5'>
                <h1 className='pt-[4.8rem] font-bold text-[1.5rem] text-white  hover:underline cursor-pointer'>Popular albums</h1>
                <h1 className='pt-[5.4rem] font-bold text-[1rem] text-[#ABABAB]'>Show all</h1>
            </div>
